...
class XG_uk_Form(FlaskForm):
    veff = IntegerField('veff',
                       validators=[DataRequired()],
                       render_kw={
                           'id':'veff',
    ...
    pld = FloatField('pld',
                       ...
                       render_kw={
                           'id':'pld',
                           'placeholder':"Please keep 2 decimal places"
                       })
    rdls = FloatField('rdls',
                       validators=[DataRequired()],
                       render_kw={
                           'id':'rdls',
                           'placeholder': "Please keep 4 decimal places"
                       })
